...
CREATE TABLE ediskperf (
    tps DOUBLE PRECISION,
    rd_sec_s DOUBLE PRECISION,
    wr_sec_s DOUBLE PRECISION,
    avgrq_sz DOUBLE PRECISION,
    avgqu_sz DOUBLE PRECISION,
    await DOUBLE PRECISION,
    svctm DOUBLE PRECISION,
    perc_util DOUBLE PRECISION,
    blks_s DOUBLE PRECISION,
    machineId integer,
    processorId integer,
    ewfid integer,
    taskId integer
