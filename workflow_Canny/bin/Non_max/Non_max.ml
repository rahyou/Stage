...
open Images
    ...
    kernel non_max_kernel : Spoc.Vector.vint32-> Spoc.Vector.vint32 -> int -> int -> unit = "kernels/non_max_kernel" "non_max_kernel"
...
let _ =
  ...
  let non_max_kernel = non_max_kernel in  
...
*)
    ...
    non_max_kernel#compile (~debug: true) !dev;
    Spoc.Kernel.run !dev (block, grid) non_max_kernel (a, res, img.Rgb24.width, img.Rgb24.height);
