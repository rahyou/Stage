...
let read_ascii_24 c =
 ...
 Unix.mkdir  ("/home/racha/Documents/stage/workflow_Canny_MapReduce/Output/"^id^"/2/") 0o777;
 Unix.mkdir  ("/home/racha/Documents/stage/workflow_Canny_MapReduce/Output/"^id^"/3/") 0o777;
 Unix.mkdir  ("/home/racha/Documents/stage/workflow_Canny_MapReduce/Output/"^id^"/4/") 0o777;
 
  let oc1 = open_out ("/home/racha/Documents/stage/workflow_Canny_MapReduce/Output/"^id^"/1/parte1.ppm") in
  let oc2 = open_out ("/home/racha/Documents/stage/workflow_Canny_MapReduce/Output/"^id^"/2/parte2.ppm") in
  let oc3 = open_out ("/home/racha/Documents/stage/workflow_Canny_MapReduce/Output/"^id^"/3/parte3.ppm") in
  let oc4 = open_out ("/home/racha/Documents/stage/workflow_Canny_MapReduce/Output/"^id^"/4/parte4.ppm") in
 ...
 for i=0 to lins -1 do
  ...
  begin     
   ...
   let oc = open_out "Erelation.txt" in
    ...
    Printf.fprintf oc "/home/racha/Documents/stage/workflow_Canny_MapReduce/Output/%s/1/parte1.ppm\n" id ;
        Printf.fprintf oc "%d;" (int_of_string(id));

    Printf.fprintf oc "/home/racha/Documents/stage/workflow_Canny_MapReduce/Output/%s/2/parte2.ppm\n" id;
        Printf.fprintf oc "%d;" (int_of_string(id));

    Printf.fprintf oc "/home/racha/Documents/stage/workflow_Canny_MapReduce/Output/%s/3/parte3.ppm\n" id;
        Printf.fprintf oc "%d;" (int_of_string(id));

    Printf.fprintf oc "/home/racha/Documents/stage/workflow_Canny_MapReduce/Output/%s/4/parte4.ppm\n" id;
